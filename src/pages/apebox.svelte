<Page name="pasticceria">
    <Navbar large sliding={false} backLink="Back">
  
      <NavTitle sliding>Apebox</NavTitle>
      <NavTitleLarge>Apebox</NavTitleLarge>
    </Navbar>
      <List mediaList>
        <ListItem
            link="/nord/"
        ...
        <ListItem
        link="/grandeabbuffata/"
          title="La grande abbuffata"
          after="15€"

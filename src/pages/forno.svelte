<Page name="Prodotti da forno">
  ...
  <Block>
    <!--<p>Ogni sacchetto pesa 250G, ad esempio se vengono ordinati 2 sacchetti ne verra fatto solo uno da 500G e cos� via, per richieste specifiche scrivere nelle note dell'ordine</p>-->
  </Block>
    <List mediaList>
      <ListItem
        title="Cupcake"

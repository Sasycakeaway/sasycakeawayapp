<Page name="about">
    <Navbar large sliding={false} backLink="Back">
      ...
      <NavTitle sliding>Privacy policy</NavTitle>
      <NavTitleLarge>Privacy policy</NavTitleLarge>
    </Navbar>
    ...
    <p>Sabrina Vitrani</p>
    <p>Viale falchera 69</p>
    <p>Partita IVA: 12192520018</p>
    <p>Codice Fiscale:  VTRSRN70S49L219</p>
    
    <p>saranno trattati in modo lecito e secondo correttezza per le seguenti finalità: </p>
    
    <p>Nome,cognome,indirizzo di casa,email e numero di telefono. Servono per eseguire l'ordine attraverso l'app</p>
    ...
    <p>I Vs. dati personali saranno conservati per nr. 10 anni, dalla cessazione del rapporto di erogazione del servizio/di fornitura del prodotto presso gli archivi informatici di proprietà di Sabrina Vitrani. </p>
    ...
    <p>Titolare del trattamento dei dati è la Sabrina Vitrani. Dati contatti del Titolare del trattamento, mail : sasy.vitrani@gmail.com</p>
